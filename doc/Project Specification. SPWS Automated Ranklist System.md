...
- pgTAP total: 562 assertions (560 prior + 2 ADR-056 revision (5.19.4 + 5.19.5): bracket-label V-cat wins when `enum_source_age_category` is set; NULL falls back to BY-derived assertion).
