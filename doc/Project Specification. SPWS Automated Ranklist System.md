...
| [ADR-039](adr/039-stale-event-gate.md) | EVF Scraper Dedup Algorithm + Stale-Event Gate. **Rev 6 (2026-08-08):** the former empty-duplicate assumption is superseded by the scored Guildford/Munich fragmentation incident. Automated ingest still fails closed; there is no generic merge RPC. A scored conflict requires an exact-baseline, source-verified, event-specific migration that refuses registrations/match candidates and deletes only emptied named donors. | FR-58, FR-96, FR-97, ADR-028, ADR-069 |
