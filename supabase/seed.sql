-- =============================================================================
-- Seed Data: Season 2024-2025, SPWS Master Fencer List, Organizers, Event, Tournament
-- =============================================================================
-- This seed file creates:
--   - Season 2024-2025 with scoring config (via trigger)
--   - SPWS master fencer list (birth year only; ~270 members; NULL = year unknown)
--   - Organizers (SPWS, EVF)
--   - Sample event and tournament for POC testing
-- Needed for:
...
-- Season (auto-creates scoring config via trigger)
INSERT INTO tbl_season (txt_code, dt_start, dt_end, bool_active)
VALUES ('SPWS-2024-2025', '2024-08-01', '2025-07-15', TRUE);
...
-- SPWS Master fencer list — birth year only; club and nationality not tracked.
...
VALUES (
    'PPW1-KRAKOW-2025',
    'I Puchar Polski Weteranów — Kraków',
    (SELECT id_season FROM tbl_season WHERE txt_code = 'SPWS-2024-2025'),
    (SELECT id_organizer FROM tbl_organizer WHERE txt_code = 'SPWS'),
    'PLANNED'
);

-- Sample tournament (num_multiplier auto-populated by trigger)
INSERT INTO tbl_tournament (
    id_event, txt_code, txt_name, enum_type,
    enum_weapon, enum_gender, enum_age_category,
    dt_tournament, int_participant_count
) VALUES (
    (SELECT id_event FROM tbl_event WHERE txt_code = 'PPW1-KRAKOW-2025'),
    'PPW1-V2-M-EPEE-2025',
    'I Puchar Polski Weteranów — Szpada Mężczyzn V2',
    'PPW',
    'EPEE', 'M', 'V2',
    '2024-10-12', 24
);
