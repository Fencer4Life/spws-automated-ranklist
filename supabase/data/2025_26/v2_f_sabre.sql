-- =========================================================================
-- Season 2025-2026 — V2 F SABRE — generated from SZABLA-K2-2025-2026.xlsx
...
-- Compute scores for PPW1-V2-F-SABRE-2025-2026
SELECT fn_calc_tournament_scores(
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PPW1-V2-F-SABRE-2025-2026')
);

-- ---- PP2: II Puchar Polski Weteranów (SZABLA WETERANI KOBIET 2) ----
INSERT INTO tbl_event (txt_code, txt_name, txt_location, id_season, id_organizer, enum_status)
SELECT
    'PPW2-2025-2026',
    'II Puchar Polski Weteranów',
    'SZABLA WETERANI KOBIET 2',
    (SELECT id_season FROM tbl_season WHERE txt_code = 'SPWS-2025-2026'),
    (SELECT id_organizer FROM tbl_organizer WHERE txt_code = 'SPWS'),
    'COMPLETED'
...
-- Compute scores for PPW2-V2-F-SABRE-2025-2026
SELECT fn_calc_tournament_scores(
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PPW2-V2-F-SABRE-2025-2026')
);
...
INSERT INTO tbl_tournament (
    ...
    'PPW',
    'SABRE', 'F', 'V2',
    '2025-12-14', 1, 'https://www.fencingtimelive.com/events/results/EE1ED81AF6FE4D09B5C522D310B163B0',
    'SCORED'
);
INSERT INTO tbl_result (id_fencer, id_tournament, int_place, txt_scraped_name)
VALUES (
...
-- Compute scores for PPW3-V2-F-SABRE-2025-2026
SELECT fn_calc_tournament_scores(
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PPW3-V2-F-SABRE-2025-2026')
);
...
-- Compute scores for PPW4-V2-F-SABRE-2025-2026
SELECT fn_calc_tournament_scores(
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PPW4-V2-F-SABRE-2025-2026')
);
...
-- Compute scores for PEW2-V2-F-SABRE-2025-2026
SELECT fn_calc_tournament_scores(
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PEW2-V2-F-SABRE-2025-2026')
);
...
INSERT INTO tbl_tournament (
    ...
    'PEW',
    'SABRE', 'F', 'V2',
    '2026-03-29', 6, 'https://www.fencingtimelive.com/events/results/4BBA946C8359465F9EB1B97A9D2A8ACC',
    'SCORED'
);
INSERT INTO tbl_result (id_fencer, id_tournament, int_place, txt_scraped_name)
VALUES (
...
-- Compute scores for PEW7-V2-F-SABRE-2025-2026
SELECT fn_calc_tournament_scores(
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PEW7-V2-F-SABRE-2025-2026')
);
