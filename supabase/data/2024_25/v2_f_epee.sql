...
VALUES (
    246,
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP1-V2-F-EPEE-2024-2025'),
    1,
    'WASILCZUK Beata'
...
VALUES (
    246,
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP2-V2-F-EPEE-2024-2025'),
    1,
    'WASILCZUK Beata'
); -- matched: WASILCZUK Beata (score=100.0)
INSERT INTO tbl_result (id_fencer, id_tournament, int_place, txt_scraped_name)
...
VALUES (
    246,
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP3-V2-F-EPEE-2024-2025'),
    1,
    'WASILCZUK Beata'
); -- matched: WASILCZUK Beata (score=100.0)
INSERT INTO tbl_result (id_fencer, id_tournament, int_place, txt_scraped_name)
