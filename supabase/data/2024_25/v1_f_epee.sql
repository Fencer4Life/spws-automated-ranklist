...
VALUES (
    100,
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP1-V1-F-EPEE-2024-2025'),
    1,
    'KAMIŃSKA Gabriela'
...
VALUES (
    100,
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP2-V1-F-EPEE-2024-2025'),
    1,
    'KAMIŃSKA Gabriela'
); -- matched: KAMIŃSKA Gabriela (score=100.0)
INSERT INTO tbl_result (id_fencer, id_tournament, int_place, txt_scraped_name)
...
VALUES (
    127,
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP3-V1-F-EPEE-2024-2025'),
    1,
    'KOWALSKA Milena'
); -- matched: KOWALSKA Milena (score=100.0)
INSERT INTO tbl_result (id_fencer, id_tournament, int_place, txt_scraped_name)
