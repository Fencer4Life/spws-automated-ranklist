...
VALUES (
    163,
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP1-V3-M-FOIL-2024-2025'),
    1,
...
VALUES (
    163,
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP2-V3-M-FOIL-2024-2025'),
    1,
    'NIKALAICHUK Aliaksandr'
); -- matched: NIKALAICHUK Aliaksandr (score=100.0)
INSERT INTO tbl_result (id_fencer, id_tournament, int_place, txt_scraped_name)
...
VALUES (
    163,
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP3-V3-M-FOIL-2024-2025'),
    1,
    'NIKALAICHUK Aliaksandr'
); -- matched: NIKALAICHUK Aliaksandr (score=100.0)
INSERT INTO tbl_result (id_fencer, id_tournament, int_place, txt_scraped_name)
