...
VALUES (
    142,
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP1-V1-F-FOIL-2024-2025'),
    1,
    'LIPKOWSKA Dominika'
); -- matched: LIPKOWSKA Dominika (score=100.0)
-- Compute scores for PP1-V1-F-FOIL-2024-2025
...
VALUES (
    142,
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP2-V1-F-FOIL-2024-2025'),
    1,
    'LIPKOWSKA Dominika'
); -- matched: LIPKOWSKA Dominika (score=100.0)
-- Compute scores for PP2-V1-F-FOIL-2024-2025
SELECT fn_calc_tournament_scores(
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP2-V1-F-FOIL-2024-2025')
);
...
VALUES (
    142,
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP3-V1-F-FOIL-2024-2025'),
    1,
    'LIPKOWSKA Dominika'
); -- matched: LIPKOWSKA Dominika (score=100.0)
-- Compute scores for PP3-V1-F-FOIL-2024-2025
SELECT fn_calc_tournament_scores(
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP3-V1-F-FOIL-2024-2025')
);
...
-- UNMATCHED (score<80): 'QUADRI Paola' place=1
-- UNMATCHED (score<80): 'ENRIGHT Ritva Irene' place=2
-- UNMATCHED (score<80): 'KICKBUSCH Karin' place=3
INSERT INTO tbl_result (id_fencer, id_tournament, int_place, txt_scraped_name)
VALUES (
    142,
...
-- UNMATCHED (score<80): 'HERCZEG Krisztina' place=5
-- UNMATCHED (score<80): 'OSTRIKOFF Michelle' place=6
