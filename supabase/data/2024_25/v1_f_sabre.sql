...
VALUES (
    72,
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP2-V1-F-SABRE-2024-2025'),
    1,
    'GRACZYK Anna'
); -- matched: GRACZYK Anna (score=100.0)
-- Compute scores for PP2-V1-F-SABRE-2024-2025
...
VALUES (
    63,
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP3-V1-F-SABRE-2024-2025'),
    1,
    'GAWLE Katarzyna'
); -- matched: GAWLE Katarzyna (score=100.0)
-- Compute scores for PP3-V1-F-SABRE-2024-2025
SELECT fn_calc_tournament_scores(
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP3-V1-F-SABRE-2024-2025')
);
...
INSERT INTO tbl_tournament (
    ...
    'PEW1-V1-F-SABRE-2024-2025',
    'EVF Grand Prix 1 — Budapeszt',
    'PEW',
    'SABRE', 'F', 'V1',
    '2024-09-22', 7, 'https://engarde-service.com/app.php?id=4212R1',
    'SCORED'
);
-- Compute scores for PEW1-V1-F-SABRE-2024-2025
SELECT fn_calc_tournament_scores(
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PEW1-V1-F-SABRE-2024-2025')
);
