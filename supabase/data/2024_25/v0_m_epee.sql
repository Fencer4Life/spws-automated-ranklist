...
VALUES (
    51,
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP1-V0-M-EPEE-2024-2025'),
    1,
    'FRAŚ Felix'
...
VALUES (
    51,
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP2-V0-M-EPEE-2024-2025'),
    1,
    'FRAŚ Felix'
); -- matched: FRAŚ Feliks (score=85.71428571428572)
INSERT INTO tbl_result (id_fencer, id_tournament, int_place, txt_scraped_name)
...
VALUES (
    94,
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PP3-V0-M-EPEE-2024-2025'),
    1,
    'JASIELCZUK Igor'
); -- matched: JASIELCZUK Igor (score=100.0)
INSERT INTO tbl_result (id_fencer, id_tournament, int_place, txt_scraped_name)
