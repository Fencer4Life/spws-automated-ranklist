...
INSERT INTO tbl_result (id_fencer, id_tournament, int_place, txt_scraped_name)
VALUES (
    (SELECT id_fencer FROM tbl_fencer WHERE txt_surname = 'VETULANI' AND txt_first_name = 'Zygmunt' LIMIT 1),
    (SELECT id_tournament FROM tbl_tournament WHERE txt_code = 'PPW1-V4-M-FOIL-2024-2025'),
    3,
    'VETULANI Zygmunt'
...
INSERT INTO tbl_tournament (
    ...
    'MPW',
    'FOIL', 'M', 'V4',
    '2025-06-08', 3, 'https://www.fencingtimelive.com/events/results/21EA6219315840AF9BF31F5C5AACA939',
    'SCORED'
);
INSERT INTO tbl_result (id_fencer, id_tournament, int_place, txt_scraped_name)
VALUES (
...
-- SKIPPED (international, no master data): 'LIPTÁK György' place=1
-- SKIPPED (international, no master data): 'PINCEMAILLE Benoit' place=2
INSERT INTO tbl_result (id_fencer, id_tournament, int_place, txt_scraped_name)
VALUES (
