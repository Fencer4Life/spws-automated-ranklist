-- =============================================================================
-- Add entry fee currency parameter to event CRUD functions
-- =============================================================================
...
REVOKE EXECUTE ON FUNCTION fn_create_event(TEXT,TEXT,INT,INT,TEXT,DATE,DATE,TEXT,TEXT,TEXT,TEXT,NUMERIC,TEXT) FROM anon, PUBLIC;
GRANT EXECUTE ON FUNCTION fn_create_event(TEXT,TEXT,INT,INT,TEXT,DATE,DATE,TEXT,TEXT,TEXT,TEXT,NUMERIC,TEXT) TO authenticated;

REVOKE EXECUTE ON FUNCTION fn_update_event(INT,TEXT,TEXT,DATE,DATE,TEXT,TEXT,TEXT,TEXT,NUMERIC,TEXT,INT) FROM anon, PUBLIC;
GRANT EXECUTE ON FUNCTION fn_update_event(INT,TEXT,TEXT,DATE,DATE,TEXT,TEXT,TEXT,TEXT,NUMERIC,TEXT,INT) TO authenticated;
