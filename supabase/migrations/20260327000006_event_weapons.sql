-- =============================================================================
-- Add weapons array column to tbl_event
-- =============================================================================
-- Stores which weapons an event covers (usually all 3, sometimes 2 or 1).
-- Default: all three weapons. Recreates vw_calendar to expose the new column.
-- =============================================================================

ALTER TABLE tbl_event ADD COLUMN IF NOT EXISTS arr_weapons enum_weapon_type[]
  DEFAULT '{EPEE,FOIL,SABRE}';

-- Recreate vw_calendar to include weapons column
